...
function SearchForPass({ticketList}: SearchForPassProps) {
    ...
    return (<div className="w-[80%] mx-auto text-center max-md:w-[100%]">
       ...
       onChange={(e) => setOrigin(e.target.value)} />
        <button className='p-1 px-[6px] bg-white rounded-full border border-zinc-300 absolute md:right-[430px] md:bottom-[244px]
         text-zinc-600 max-md:right-32 max-md:top-[135px]' onClick={onclick}>
...
<div className="mt-5">
        {tickets.length > 0 ? (
          <ul>
            {tickets.map(ticket => (
              <li className='border border-zinc-300 w-[480px] mx-auto p-2 py-4' key={ticket.id}>
